...
public class MainFrame extends JFrame {
	...
	public MainFrame() throws HeadlessException {
		...
		/*
		 * setVisible метод графического интерфейса (в случае модального диалога -
		...
		/*
		 pack метод, ставиться перед setVisible, он в памяти подготавливает всю форму прорисовки и предотвращает
		 глюки с отображением, но окно открывается с минимальным размером
		 */
		setVisible(true);
